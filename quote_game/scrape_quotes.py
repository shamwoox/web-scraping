# A program that uses web scraping to create a game for users to guess the author of a random quote
...
def start_game(quotes):
    ...
    while guess.lower() != quote["author"].lower() and remaining_guesses > 0:
        guess = input(f"Who said this quote? Guesses remaning: {remaining_guesses}\n")
